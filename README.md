# [full stack nginx WordPress with docker compose](https://github.com/r3vela710n/full-stack-nginx-wordpress-with-docker-compose)

Quickly install a website with WordPress at short time; 
...
download with
```
git clone https://github.com/r3vela710n/full-stack-nginx-wordpress-with-docker-compose.git
```
