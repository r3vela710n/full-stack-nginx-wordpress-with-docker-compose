...
read -p 'Enter container local Timezone(default : America/New_York, to see the other timezones, https://docs.diladele.com/docker/timezones.html): ' local_timezone
